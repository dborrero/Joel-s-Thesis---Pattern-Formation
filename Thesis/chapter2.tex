...
The work done by Gameiro, Mischaikow, and others provides a wonderful backdrop and inspiration for the analysis of the 2D Gray-Scott model in this thesis. The computational method for calculating homology data of this system is outlined in \refChapter{ch:methods}. In \refsect{sect:entropy}, I describe how this can be used to derive information about the dynamics of a system.
