...
params = [[0.12, 0.06, 0.014, 0.053, "alpha"],\
	[0.16, 0.08, 0.014, 0.039, "beta"],\
	[0.16, 0.08, 0.022, 0.051, "gamma"],\
	[0.1, 0.05, 0.03, 0.055, "delta"],\
	[0.14, 0.07, 0.014, 0.055, "epsilon"],\
	[0.14, 0.07, 0.029, 0.06, "eta"],\
	[0.12, 0.06, 0.03, 0.057, "theta"],\
	[0.12, 0.06, 0.046, 0.0594, "iota"],\
	[0.16, 0.08, 0.058, 0.063, "kappa"],\
	[0.16, 0.08, 0.038, 0.065, "lambda"],\
	[0.2, 0.1, 0.060, 0.0650, "mu"],\
	[0.14, 0.07, 0.022, 0.061, "zeta"]]
...
for group in params:
	...
	for i in xrange(25000):
		...
		if i % 50 == 0:
			...
			# im.set_clim(vmin=0.20, vmax=1.0)
			stdout.write("\r vmin="+str(U.min())+", vmax="+str(U.max()) )
			stdout.flush()
			plt.draw()
			# To make movie
			plt.savefig(foldername + "/" + name + "-%04d.png" % (i/50) ,dpi=dpi)
	stdout.write("\n")
	plt.ioff()
	print name + " is done..."
